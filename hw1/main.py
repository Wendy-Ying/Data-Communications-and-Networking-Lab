...
msg = "\r\n This ia Ying Yiwen Speaking!\r\n"
endMsg = "Yours sincerely\r\n.\r\n"
# 选择一个邮件服务
mailServer = "smtp.163.com"
# 发送方地址和接收方地址，from 和 to
fromAddress = "wendying_yyw@163.com"
toAddress = "12210159@mail.sustech.edu.cn"
# 发送方，验证信息
username = "wendying_yyw"  # 输入自己的用户名对应的编码
license_key = "UErqFA4JR9A7TRtn"  # 此处不是自己的密码，而是开启SMTP服务时对应的授权码 t
username_base64 = base64.b64encode(username.encode('utf-8')) #转为base64编码格式
license_key_base64 = base64.b64encode(license_key.encode('utf-8'))
...
heloCommand = 'HELO HAIPIHUANG-NB1\r\n'#建立连接后发送HELO命令，后面跟客户端的域名或主机名
...
clientSocket.sendall(license_key_base64 + '\r\n'.encode())
...
# 编辑邮件信息，发送数据
subject = "EE315 Lab Course Mail Test"
